...
void RsGxsWireGroupItem::serial_process(RsGenericSerializer::SerializeJob j,RsGenericSerializer::SerializeContext& ctx)
{
	...
	//RsTypeSerializer::serial_process<RsTlvItem>(j,ctx,group.mHeadshot,"group.mHeadshot") ;
	//RsTypeSerializer::serial_process<RsTlvItem>(j,ctx,group.mMasthead,"group.mMasthead") ;
}
